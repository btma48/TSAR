...
class CosineAnnealingRestartCyclicLR_OCT(_LRScheduler):
    """ Cosine annealing with restarts learning rate scheme.
    An example of config:
    periods = [10, 10, 10, 10]
    restart_weights = [1, 0.5, 0.5, 0.5]
    ...
    def __init__(self,
        ...
        super(CosineAnnealingRestartCyclicLR_OCT, self).__init__(optimizer, last_epoch)
        
    def get_lr(self):
        nearest_restart = 0 
        current_period = self.periods
        eta_min = self.eta_mins
